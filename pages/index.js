...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        <title>Joseph Flores Portofolio</title>
      ...
      <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        <section className="min-h-screen">
          ...
          <div className="text-center p-10 ">
            ...
            <h3 className="text-2xl py-2 md:text-3xlxl dark:text-gray-400">
        ...
        <section>
          <div mx-auto>
            <h3 className="text-3xl py-1 dark:text-white">Services I ofer</h3>
            <p className="text-md py-2 leading-8 text-gray-400">
              Since the beginning of my journey as a freelancer developer, I've
              done remorte work for
              <span className="text-teal-500"> agencies</span> consulter for{" "}
          ...
          <div className="lg:flex gap-10">
            <div className="mx-auto text-center shadow-lg p-10 rounded-xl my-10 dark:bg-teal-600">
              <Image
                className="mx-auto"
                src={design}
                width={100}
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 dark:text-gray-500">
          ...
          <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
            <div className="basis-1/3 flex-1 ">
              <Image
                src={web1}
                clasname="rounded-lg object-cover"
                width={"100%"}
                height={"100%"}
                layout="responsive"
              />
